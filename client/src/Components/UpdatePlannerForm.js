...
function UpdatePlannerForm({ planners, setPlanners, planner, handleUpdateToggle }) {
...
// const [updatedPlanner, setUpdatedPlanner] = useState([])
...
const handleUpdateSubmit = (e) => {
    ...
    //   const updatedPlanners = planners.map(planner => planner.id === updatedPlanner.id ? updatedPlanner : originalPlanner)
    //   setPlanners(updatePlanner)
    //     let updatedPlanners = planners.map(planner => {
    //           if (planner.id === updatedPlanner.id) {
    //                   return updatedPlanner
    //               } else {
    //                       return planner
