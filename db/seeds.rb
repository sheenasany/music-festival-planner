...
f1 = Festival.create(name:"Hangtown Music Festival", date: "October 20-23, 2022", lineup_poster: "https://www.musicfestivalwizard.com/wp-content/uploads/2022/05/Hangtown-2022-Lineup-Poster.jpg", average_attendance: "40,000" , average_ticket_price: 290 , link: "http://hangtownfestival.com/", genre: "Folk", has_camping: true , marker_id: m1.id )
...
p1 = Planner.create(budget: 100, transportation: "Car", lodging: "Sis staying at a hotel, I'm going back home.", friends_attending: "Sister, Marthica!", additional_notes: "Omg, like literally everything.", festival_id: f2.id, user_id: u4.id)
p2 = Planner.create(budget: 2000, transportation: "Car", lodging: "Tent Camping", friends_attending: "My sweet honey boo, Joe", additional_notes: "Blankets and beer", festival_id: f1.id, user_id: u1.id)
